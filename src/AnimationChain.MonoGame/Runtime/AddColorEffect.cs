...
/// at the repo root) and caches one <see cref="Effect"/> instance per <see cref="GraphicsDevice"/>.
/// </summary>
internal static class AddColorEffect
{
    ...
    public static Effect Get(GraphicsDevice graphicsDevice)
    {
        ...
        using var stream = Assembly.GetExecutingAssembly()
            .GetManifestResourceStream("FlatRedBall.AnimationChain.Shaders.AddColor.mgfx")!;
